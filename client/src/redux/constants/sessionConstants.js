...
export const SESSION_GET_FAIL = 'SESSION_GET_FAIL';

export const SESSION_PARTICIPANT_GET_ALL_REQUEST = 'SESSION_PARTICIPANT_GET_ALL_REQUEST';
export const SESSION_PARTICIPANT_GET_ALL_SUCCESS = 'SESSION_PARTICIPANT_GET_ALL_SUCCESS';
export const SESSION_PARTICIPANT_GET_ALL_FAIL = 'SESSION_PARTICIPANT_GET_ALL_FAIL';
