...
export const courseRemoveParticipant = (state = {}, action) => {
    switch (action.type) {
        case COURSE_DELETE_PARTICIPANT_REQUEST:
            return { loading: true };
        case COURSE_DELETE_PARTICIPANT_SUCCESS:
            return {
                loading: false,
                success: true,
                response: action.payload,
            };
        case COURSE_DELETE_PARTICIPANT_FAIL:
            return {
                loading: false,
                error: action.payload,
            };
